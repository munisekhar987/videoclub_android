...
/**
 * Adapter for right menu in NewHomeScreenActivity
 */
public class RightMenuAdapter extends RecyclerView.Adapter<RightMenuAdapter.ViewHolder> {
    ...
    public RightMenuAdapter(Context context, List<MenuItem> menuItems) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_right_menu, parent, false);
