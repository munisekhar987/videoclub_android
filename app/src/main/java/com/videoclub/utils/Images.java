...
public class Images {
    ...
    public static final int cross = R.drawable.cross;
    public static final int homeiconred = R.drawable.homeiconred;
    public static final int worldtvbg = R.drawable.worldtvbg;
    public static final int searchicon = R.drawable.search;
